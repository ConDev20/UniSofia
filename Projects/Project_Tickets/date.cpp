...
{
    std::cout <<year<<"-";
    //Ако числата са по малки от 10, дописва 0, с цел отговаряне на изискванията за формат на дата
    if(month <10)
    {
...
{
    /// Нужен за сравняването на обекти от тип Event и за сортирането на вектор от представления 
